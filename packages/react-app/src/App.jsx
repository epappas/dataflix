...
function App(props) {
  ...
  // 🏗 dataflix is full of handy hooks like this one to get your balance:
  ...
  const purpose = useContractReader(readContracts, "Dataflix", "purpose", [], localProviderPollingTime);
  ...
  */
  ...
  useEffect(() => {
    if (
      ...
      console.log("_____________________________________ 🏗 dataflix _____________________________________");
